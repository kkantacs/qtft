...
# --- Load data ---
# This example demonstrates the model using Axis Bank stock data.
# The same preprocessing and modeling pipeline applies to the
# Seattle weather dataset.
# The implementation works for both configurations: with LSTM
# and without LSTM.
